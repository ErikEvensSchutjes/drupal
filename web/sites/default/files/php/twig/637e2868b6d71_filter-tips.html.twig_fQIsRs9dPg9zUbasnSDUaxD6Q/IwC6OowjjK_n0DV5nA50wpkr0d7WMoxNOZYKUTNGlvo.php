...
class __TwigTemplate_b7f166cd9f43b4dd4696881e09243921dcd8b8b4619012a77bce351730287cbd extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "C:\\xampp8\\htdocs\\watering\\web\\core\\themes\\classy\\templates\\content-edit\\filter-tips.html.twig");
    }
